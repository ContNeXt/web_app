...
----------------------------------
1. Check that you have the latest version of :code:`contnextViewer`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/gitlab.scai.fraunhofer/gitlab.scai.fraunhofer/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/gitlab.scai.fraunhofer/gitlab.scai.fraunhofer
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/gitlab.scai.fraunhofer
...
If you spend a while working on your changes, further commits may be made to the main :code:`contnextViewer`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/gitlab.scai.fraunhofer/gitlab.scai.fraunhofer
