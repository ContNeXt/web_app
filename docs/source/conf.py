...
project = 'contnextViewer'
copyright = f'{date.today().year}, sara_diaz'
author = 'sara_diaz'
...
modindex_common_prefix = ["contnextViewer."]
...
htmlhelp_basename = 'ContNextViewerdoc'
